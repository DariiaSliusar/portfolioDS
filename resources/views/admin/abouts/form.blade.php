...
<div class="card-wrapper">
    ...
    <div class="wrapper_right">
        <div class="card">
            ...
            <img
                src="{{ isset($about->home_image) ? asset('images/'.$about->home_image) : asset('template/assets/img/avatar.jpg') }}"
                class="avatar_img"
        ...
        <div class="card">
            ...
            <img
                src="{{ isset($about->banner_image) ? asset('images/'.$about->banner_image) : asset('template/assets/img/avatar.jpg') }}"
                class="avatar_img"
